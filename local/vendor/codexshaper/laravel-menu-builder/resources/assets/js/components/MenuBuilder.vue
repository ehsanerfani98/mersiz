                    ...
                    <div class="col-md-12">
                        <div class="create-btn">
                            <button
                                ...
                                data-toggle="modal"
                                data-target="#addMenuItemModal"><i class="material-icons">adds</i> افزودن منو جدید</button>
                            <button
                                v-on:click="showSettingsForm"
                                class="btn btn-info edit-info"
                                data-toggle="modal"
                                data-target="#settingsModal"><i class="material-icons">settings_appl</i> تنضیمات</button>
                            <button
                                id="show_menu_design"
                                class="btn btn-info edit-info"
                                :data-id="menu.id"
                                :data-prefix="prefix"
                                data-toggle="modal"
                                data-target="#showMenuModel"><i class="material-icons">visibility</i> پیشنمایش</button>
                        </div>
