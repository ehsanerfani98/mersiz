...
@section('Admin_content')
    ...
    <div class="col-xs-12" style="margin-bottom: 30px">
        <div>
            <h2>
                ...
                <b style="color: #555;margin: 3px 5px 0 0;float: right;font-size: 18pt;">ویرایش سوالات متداول</b>
            </h2>
    ...
    {!! Form::model($faq, ['method' => 'PATCH', 'action' => ['Admin\AdminFaqController@update', $faq->id], 'files' => true]) !!}
        <div class="row">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input onkeyup="convertToSlug()" type="text" id="title" name="Question"
                                                           class="form-control" value="@if(old('Question')==""){{$faq->Question}}@else{{old('Question')}} @endif">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                {{--                                                </select>--}}
                                                {{ Form::select('status', ['DRAFT' => 'پیش نویس', 'PUBLISHED' => 'انتشار'],$faq->status, ['class' => 'selectpicker form-control show-tick']) }}
