...
@section('Admin_content')
    ...
    <!-- Hover Rows -->
    <div class="row">
        <form id="form" action="{{route('returnpolicy.store')}}" method="post">
            <div class="col-xs-12 head" style="margin-bottom: 60px;display: flex;justify-content: space-between">
                <div style="min-width: 150px">
                    <h2 style="margin-top: 0">
                        <i style="float: right;font-size: 29pt;color: #555;" class="material-icons">rotate_90_degrees_ccw</i>
                        <b style="color: #555;margin: 3px 5px 0 0;float: right;font-size: 18pt;">شرایط مرجوعی کالا</b>
                    </h2>
                </div>
                        ...
                        <div class="card">
                            <div class="body">
                                ...
                                <textarea id="editor1" name="content"
                                          class="form-control">@if(old ('content')){{old ('content')}}@else{{$about->content}}@endif</textarea>
                            </div>
                        </div>
                    </div>
                </div>
