...
@section('Admin_content')
    ...
    <!-- Hover Rows -->
    <div class="row">
        <form id="form" action="{{route('about.store')}}" method="post">
            <div class="col-xs-12 head" style="margin-bottom: 60px;display: flex;justify-content: space-between">
                <div style="min-width: 150px">
                    <h2 style="margin-top: 0">
                        <i style="float: right;font-size: 29pt;color: #555;" class="material-icons">camera_front</i>
                        <b style="color: #555;margin: 3px 5px 0 0;float: right;font-size: 18pt;">درماره ما</b>
                    </h2>
                </div>
