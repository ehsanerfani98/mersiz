                        ...
                        <div class="col-xs-12 col-lg-12 " style="background: white;padding-top: 20px">
                            ...
                            <div class="body">
                                ...
                                <div class="col-xs-12 col-lg-12 value"  style="padding-right: 50px">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="value[]" class="form-control" placeholder="مقدار" value="{{$attribute_value->value}}">
                                            @if($i!=1)
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control show-tick" name="category">
                                                ...
                                                @foreach($categories as $category)
                                                    <option @if($category->id==$attribute->category_id)selected @endif value="{{$category->id}}">{{$category->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
