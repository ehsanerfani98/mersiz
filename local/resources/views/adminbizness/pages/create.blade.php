    ...
    <div class="col-xs-12" style="margin-bottom: 30px">
        <div>
            <h2>
                ...
                <b style="color: #555;margin: 3px 5px 0 0;float: right;font-size: 18pt;">افزودن برگه جدید</b>
            </h2>
            <a href="{{ route('pages.index') }}" style="float: left" title="برگشت"> <i
                            ...
                            <div class="card">
                                ...
                                <div class="body">
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="submit" value="ایجاد برگه جدید"
