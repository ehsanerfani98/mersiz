...
@section('Admin_content')
    ...
    <div class="col-xs-12 head" style="margin-bottom: 20px;display: flex;justify-content: space-between">
        <div style="width: 100%">
            ...
            <a href="{{route('user-s.index')}}" style="float: left" title="برگشت"> <i
                        ...
                        @can('users_status')
                            <li style="margin-bottom: 0">
                                ...
                                <div class="switch" align="center">
                                    <label><span style="float: left">غیر فعال</span><input id="active_user"
                                                                                           type="checkbox"
                ...
                <div class="body">
                    ...
                    <div>
                        ...
                        <form class="form-horizontal" method="post" autocomplete="off"
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="email" class="form-control" id="email" name="email"
                                               placeholder="ایمیل را وارد کنید" value="@if(old('email')){{old('email')}}@else{{$user->email}}@endif">
                                    </div>
                                    @if ($errors->has('email'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group">
                                <label for="Marketing_price" class="col-sm-3 control-label">موجودی کیف پول</label>
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="number" class="form-control" id="Marketing_price" name="Marketing_price"
                                               placeholder="موجودی را وارد کنید" value="@if(old('Marketing_price')){{old('Marketing_price')}}@else{{$user->Marketing_price}}@endif">
                                    </div>
