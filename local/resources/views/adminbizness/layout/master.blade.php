...
header("Location: " . URL::to('/profile'), true);
?>
...
<style>
   ...
   /* nav {
    ...
    .slimScrollDiv .education.active > a {
        background-color: rgba(14, 141, 162, 0.5) !important;
    }
    .ml-menu li.active{
        background-color: rgb(14 141 162 / 25%) !important
    }
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            ...
            <ul class="list scroll-box" style="height: 440px">
                ...
                @can('tool')
                    <li class="education @if(@$Active_list=="tool")active @endif">
                        <a href="javascript:void(0);"
                           class="menu-toggle">
                        ...
                        <ul class="ml-menu">
                            @can('menu')
                                <li class="dashboard @if(@$Active=="menu")active @endif">
...
<script>
    tinymce.init({
        ...
        images_upload_url: '/admin/ajax/TinyImage',
