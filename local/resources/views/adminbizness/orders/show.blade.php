...
@section('Admin_content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: -20px;margin-bottom: 20px;">
            <a href="{{route('orders-product.index')}}" style="float: left" title="برگشت"> <i
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            {{--            <div class="card">--}}
            <div class="header" style="border: 1px solid #555;">
        <div id="app"></div>
            </div>
        </div>
    </div>
    @php
    if ($orders[0]->location){
     $mapss=explode('(',$orders[0]->location);
