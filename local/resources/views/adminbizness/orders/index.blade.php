...
@section('Admin_content')
    ...
    <div class="row">
            ...
            <div class="header">
                <div class=""
                    ...
                    <h2 style="margin-top: 0">
                        <i style="float: right;font-size: 29pt;color: #555;" class="material-icons">shopping_cart</i>
                        <b style="color: #555;margin: 8px 5px 0 0;float: right;font-size: 18pt;"> لیست سفارشات</b>
                    </h2>
                    <div class="col-lg-6" align="left">
                        <a href="{{route('orders.report')}}" class="btn bg-orange waves-effect " title="خروجی اکسل">
                            <i class="material-icons">save</i>
                            <span>خروجی اکسل از همه سفارشات</span>
                        </a>
                    </div>
                ...
                <table id="orders" class="table table-striped table-hover dataTable js-exportable" style="text-align: center;background: white">
                    ...
                    @foreach($orders as $itemm)
                        ...
                        <tr style="vertical-align: middle">
                            ...
                            <td>@if($item->send_day=="پست ویژه")<span class="badge bg-orange">پست ویژه</span> @else  معمولی@endif</td>
        ...
        <div style="display: block;background: #fff;text-align: center;width: 100%;">
            {{$orders->links()}}
        </div>
    </div>
@endsection
