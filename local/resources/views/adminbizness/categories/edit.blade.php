...
@section('Admin_content')
                ...
                <div class="col-lg-4 col-xs-12 col-sm-12" style="margin-right: 0">
                    <div class="row">
                                ...
                                <div class="form-group form-float">
                                    <select required id="status" name="parent"
                                        ...
                                        @foreach($categories as $cat)
                                            <option @if($category->parent==$cat->id)selected @endif value="{{$cat->id}}">{{$cat->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-12 col-lg-12 ali-m-bottom-6" style="background: white;padding-top: 20px">
                            ...
                            <div class="body">
                                <div class="form-group form-float">
                                    <select required id="status" name="showindex" onchange="show_Status(this)"
                                            class="selectpicker form-control show-tick show-index">
                                        <option value="NO" @if($category->showindex=="NO")selected @endif>نمایش داده نشود</option>
                                        <option value="Up" @if($category->showindex=="Up")selected @endif>نمایش در بالا</option>
                                        <option value="Down" @if($category->showindex=="Down")selected @endif>نمایش در پایین</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-lg-12 ali-m-bottom-6 show-status" style="background: white;padding-top: 20px;display: none">
                            <div class="header ali-border-b">
                                <h5>
                                    حالت نمایش
                                </h5>
                            ...
                            <div class="body">
                                <div class="form-group form-float">
                                    <select required id="status" name="status"
                                            class="selectpicker form-control show-tick">
                                        <option value="small" @if($category->status=="small")selected @endif>کوچیک</option>
                                        <option value="big" @if($category->status=="big")selected @endif>بزرگ</option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function show_Status(){
            var value=$('select[name=showindex]').val()
            if (value!="NO"){
                $('.show-status').show();
            }else {
                $('.show-status').hide();
