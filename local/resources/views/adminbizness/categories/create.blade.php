                ...
                <div class="col-lg-4 col-xs-12 col-sm-12" style="margin-right: 0">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-lg-12 ali-m-bottom-6 " style="background: white;padding-top: 20px">
                            ...
                            <div class="body">
                                <div class="form-group form-float">
                                    <select required id="status" name="showindex" onchange="show_Status()"
                                            class="selectpicker form-control show-tick show-index ">
                                        <option value="NO">نمایش داده نشود</option>
                                        <option value="Up">نمایش در بالا</option>
                                        <option value="Down">نمایش در پایین</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="body">
                                <div class="form-group form-float">
                                    <select required id="status" name="status"
                                            class="selectpicker form-control show-tick">
                                        <option value="small">کوچیک</option>
