...
@section('Admin_content')
    ...
    <div class="col-xs-12" style="margin-bottom: 30px">
        <div>
            <h2>
                ...
                <b style="color: #555;margin: 3px 5px 0 0;float: right;font-size: 18pt;">افزودن بنر پایین سایت</b>
            </h2>
            <a href="{{route('Proposal-image.index')}}" style="float: left" title="برگشت"> <i style="float: right;font-size: 29pt;color: #555;" class="material-icons">keyboard_backspace</i></a>
    ...
    <form action="{{route('Proposal-image.store')}}" method="post" enctype="multipart/form-data">
    <div class="row">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                {{--                                                </select>--}}
                                                {{ Form::select('status', ['Show' => 'نمایش','DontShow' => 'عدم نمایش'], ['class' => 'selectpicker form-control show-tick']) }}

                                            </div>
                                        </div>

                                        <div class="col-lg-12">
                                            <input type="submit" value="ایجاد بنر جدید" class="btn btn-success btn-block waves-effect"/>
                                        </div>
