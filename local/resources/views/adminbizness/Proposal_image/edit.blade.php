    ...
    <div class="col-xs-12" style="margin-bottom: 30px">
        <div>
            <h2>
                ...
                <b style="color: #555;margin: 3px 5px 0 0;float: right;font-size: 18pt;">ویرایش بنر پایین سایت</b>
            </h2>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                {{--                                                </select>--}}
                                                {{ Form::select('status', ['Show' => 'نمایش','DontShow' => 'عدم نمایش'],$Proposal->status, ['class' => 'selectpicker form-control show-tick']) }}
