                                    ...
                                    <div class="col-xs-12 col-lg-12">
                                        <div class="form-group form-float ">
                                            ...
                                            <div class="form-line">
                                                ...
                                                {{ Form::textarea('content', $product->content, ['class' => 'form-control', 'id'=>'editor1']) }}
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-lg-12">
                                        <div class="form-group form-float">
                                            <label class="form-label" style="top: -15px;"> وضیعت : </label>
                                  ...
                                  {{--  <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group form-float">
                                            <label class="form-label" style="top: -15px;"> جزو سبد روز : </label>
                                            <select required id="special" name="day_basket"
                                                    class="selectpicker form-control show-tick">

                                                <option value="NO" @if($product->day_basket=="NO")selected @endif>خیر</option>
                                                <option value="YES" @if($product->day_basket=="YES")selected @endif>بله</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12" style="text-align: center">
                                        <a target="_blank" href="{{asset(@$linkdownload->path)}}" class="btn btn-warning btn-block waves-effect">نمایش فایل</a>
                                        <a href="{{route('fileDownload.delete', @$linkdownload->id)}}" class="btn waves-effect waves-light btn-small bg-red" style="margin-top: 10px">حذف فایل</a>
                                    </div>
                                        @endif
                                </div>
                            </div>
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-xs-12 col-lg-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                {{ Form::number('buy_limited', old('buy_limited'), ['class' => 'form-control']) }}
                                                <label class="form-label"> محدودیت خرید : </label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-lg-12">
                                        <div class="form-group form-float">
                                            <select required id="status" name="brand"
                                                    class="selectpicker form-control show-tick">
                                                <option value="0">بدون برند</option>
                                                @foreach($brands as $brand)
                                                    @php $imgBrand='<img width="30px" style="float:right;margin-left: 5px;" src="'.asset($brand->imgPath).'">' @endphp
                                                    <option @if($brand->id==$product->brand)selected @endif data-subtext="{{$imgBrand}}" value="{{$brand->id}}">{{$brand->title}} </option><img src="{{asset($brand->imgPath)}}">
                                                @endforeach
                                            </select>
                                        </div>
...
@endif
                                    ...
                                    @if($product->video!="")
                                    <div class="col-lg-12" style="text-align: center">
                                        <a href="{{route('videoproduct.delete', @$product->id)}}" class="btn waves-effect waves-light btn-small bg-red" style="margin-top: 10px">حذف ویدیو</a>
                                    </div>
                                        @endif
