                ...
                <div class="sidebar-wrapper">
                    <div class="listing-sidebar mb-4">
                        ...
                        <div class="box">
                            ...
                            <ul style="list-style: none" class="scroll-box">
                                @foreach($brands as $brand)
                                <li><a style="color: #535353" href="/search/brand/{{$brand->link}}"><img style="margin: 10px;" width="30px" src="{{asset($brand->imgPath)}}">{{$brand->title}}</a></li>
                                @endforeach
                            </ul>
                            </div>
                        </div>
                ...
                <div class="d-flex align-items-center mb-16">
                    ...
                    <nav class="ml-auto d-none d-lg-block" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/search/brand/{{$slug}}">برند : {{$slug}}</a></li>
...
@section('script')
    ...
    <script>
        function doSearch() {
            ...
            var url = '{{route('shop.doSearch_brand')}}';
            ...
            $.post(url, data, function (msg) {
                ...
                if (pageName>1){
                    ...
                    for (i = 0; i <= pageName; i++) {
                        ...
                        href+="?page="+Num+"&sort="+sort+"&limit="+limit+exist_url+attribute_url+"&amount="+amount;
                        $('.pagination').append('<li class="page-item '+active+'"><a class="page-link" href="{{$slug}}?page='+Num+'&sort='+sort+'&limit='+limit+exist_url+attribute_url+'&amount='+amount+'">'+Num+'</a></li>')
